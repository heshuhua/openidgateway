...
@EnableZuulProxy
public class OpenidgatewayApp {

    private static final Logger log = LoggerFactory.getLogger(OpenidgatewayApp.class);

    private final Environment env;

    public OpenidgatewayApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes openidgateway.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(OpenidgatewayApp.class);
